...
#include "spin_boson_2d_sin_potential.hpp"
...
bool argparse(int argc, char** argv) 
{
    ...
    desc.add_options()
        ...
        ("alpha", po::value<double>(&alpha), "coupling parameter alpha")
...
void afssh_nd_mpi() {
    // potential para
    set_potenial_params( vector<double> { mass[0], mass[1], omega[0], omega[1], g[0], g[1], dG0, V, alpha, phi0 });
