#ifndef _SPIN_BOSON_2D_SIN_POTENTIAL_HPP
#define _SPIN_BOSON_2D_SIN_POTENTIAL_HPP
...
namespace {
    ...
    void output_potential_params() {
        ioer::info("# 2D_SIN Spin Boson Potential parameters: ", 
                    " mass = ", param_mass,
                    " omega = ", param_omega,
                    " g = ", param_g,
                    " dG0 = ", param_dG0,
...
#endif // _SPIN_BOSON_2D_SIN_POTENTIAL_HPP
